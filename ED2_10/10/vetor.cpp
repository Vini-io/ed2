...
vetor::vetor(int TAM) : array(nullptr), arraySelection(nullptr), arrayInsertion(nullptr), arrayBubble(nullptr), arrayMerge(nullptr), arrayHeap(nullptr), tam(0), excSelection(0), excInsertion(0), excBubble(0), execMerge(0), execHeap(0){
...
void vetor::insertArray(){
    ...
    for(int i = 0; i < tam; i++){
       arrayHeap[i] = arrayMerge[i] = arrayBubble[i] = arrayInsertion[i] = arraySelection[i] = array[i] = distr(gen);
