...
void arquivo::createVetorAluno(Vetor_alunos &vetor_alunos)
{
    ...
    arquivo.open("C:/Users/vini/Desktop/atividades/ED2_12/tabela_hash/DadosDosAlunos_Matricula_Nome.csv");
    ...
    if(arquivo.is_open()){
        ...
        while(std::getline(arquivo, attr)){
            ...
            //objAluno->createAluno(std::stoi(M_A[0]), QString::fromStdString(M_A[1]));
